(function($){
    $.fn.ajaxImageUpload = function(options){
        ...
        var inputName = thisObj.attr('set-name');
        var sendServer= thisObj.attr('name');
        ...
        var ajaxUpload = function () {
            ...
            if(fileData){
                ...
                // 目前仅支持单图上传
                formData.append(sendServer, fileData[0]);
            ...
            $.ajax({
                ...
                success:function(json){
                    ...
                    var callbackFieldName = config.callbackFieldName;
                    imageShow.attr('src', json[callbackFieldName]);
                    imageShow.siblings('input').val(json[callbackFieldName]);
        ...
        var createImageZoom = function () {
            ...
            var zoomContent = $("<div id='zoom-content'><img src='/static/upload/4_b.jpg'></div>");
